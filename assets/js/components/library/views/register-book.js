...
<div class="mx-lg-5 my-5 mx-md-3 mx-sm-3 mx-xs-3">
    <h5><a class="color-text" href="index.php">Inicio</a> | <a class="color-text">Biblioteca</a> | <aclass="color-text">${libroData ? `Edición de Libro` : `Registro de Libro`}</a></h5>
     <button id="goBackBtn" class="btn btn-outline-secondary mt-3">Regresar</button>
    </div>
...
<div class="container-form container my-5">
    ...
    <form method="POST" class="row g-4" id="register-book-form" ${libroData ? 'data-edit-mode="true"' : '' }>${libroData? `
        ...
        <div class="col-md-6">
            <div class="mb-3">
                <label for="fecha_publicacion" class="form-label fw-bold" style="color: #2B3A55;">Fecha de
                    publicación</label>
                <input type="date" name="fecha_publicacion" id="fecha_publicacion" class="form-control"
                    style="border-color: #DEE2E6;" placeholder="Formato: yyyy/mm/dd" ${libroData ? 'disabled' : '' }
                    required>
                <span class="invalid-feedback"></span>
            </div>
        </div>
        ...
        <div class="col-12">
            <div class="mb-3">
                ...
                <textarea name="descripcion" maxlength="200" id="descripcion" class="form-control" autocomplete="off"
                    style="height: 100px; border-color: #DEE2E6;" ${libroData ? 'disabled' : '' } required></textarea>
                <span class="invalid-feedback"></span>
            </div>
        </div>
                ...
                <div class="tags-section mb-4">
                    ...
                    <div class="position-relative">
                        <div class="input-group">
                            <input type="text" id="tagInput" class="form-control" autocomplete="off"
                                placeholder="Haz clic para ver categorias disponibles" ${libroData ? 'disabled' : '' }>
                            <button class="btn btn-outline-dark" type="button" id="tagAddBtn" ${libroData ? 'disabled'
                                : '' }>Agregar</button>
                        </div>
            ...
            <div class="mb-3">
                ...
                <div class="input-group mb-2">
                    <input type="text" id="nombre" name="nombre" class="form-control" autocomplete="off"
                        placeholder="Nombre" ${libroData ? 'disabled' : '' }>
                    <input type="text" id="apellido" class="form-control" autocomplete="off" placeholder="Apellido"
                        ${libroData ? 'disabled' : '' }>
                    <button type="button" class="btn btn-outline-dark" id="addAuthor" ${libroData ? 'disabled' : ''
                        }>Agregar</button>
                </div>
        ...
        <div class="col-md-6">
            <div class="mb-3">
                ...
                <input type="text" name="editorial" id="editorial" maxlength="50" class="form-control"
                    autocomplete="off" style="border-color: #DEE2E6;" ${libroData ? 'disabled' : '' } required>
                <span class="invalid-feedback"></span>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="mb-3">
                ...
                <select name="estado" id="estado" class="form-select" ${libroData ? 'disabled' : '' } required>
                    ...
                    <option value="INACTIVO" ${libroData.estado_libro_id==='INACTIVO' ? 'selected' : '' }>Inactivo
                    </option>
                </select>
                <span class="invalid-feedback"></span>
            </div>
        ...
        <div class="col-md-6">
            <div class="mb-3">
                ...
                <input type="text" name="isbn_libro" id="isbn_libro" maxlength="50" class="form-control"
                    autocomplete="off" style="border-color: #DEE2E6;" ${libroData ? 'disabled' : '' } required>
                <span class="invalid-feedback"></span>
            </div>
        </div>
        ...
        <div class="col-12">
            ...
            application/x-mobi8-ebook, text/plain, application/rtf, text/rtf" class="form-control" ${!libroData
                    ? 'required' : "" } ${libroData ? 'disabled' : '' }>
                <span class="invalid-feedback"></span>

                ${libroData?.libro_url ? `
                <div class="mt-2">
                    <small>PDF actual: </small>
                    <a href="${ConstValues.UPLOADS_BASE_URL}${libroData.libro_url}" target="_blank"
        ...
        <div class="col-12 text-center">
            ${libroData ? `
            <button type="button" id="enableEditBtn" class="btn btn-success btn-lg px-5 fw-bold">Habilitar
                Edición</button>
            <button type="submit" class="btn btn-dark btn-lg px-5 fw-bold d-none" id="submitEditBtn">Confirmar
                cambios</button>
            ` : `
