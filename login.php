...
<body>
  ...
  <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
    <div class="carousel-inner">
      ...
      <div class="carousel-item">
        <img class="d-block w-100" src="img/1847.jpg" alt="Third slide">
      </div>
      <div class="carousel-item">
        <img class="d-block w-100" src="img/K1K2.jpg" alt="Third slide">
      </div>
      <div class="carousel-item">
        <img class="d-block w-100" src="img/C3.jpg" alt="Third slide">
      </div>
      <div class="carousel-item">
        <img class="d-block w-100" src="img/I1.jpg" alt="Third slide">
      </div>
      <div class="carousel-item">
        <img class="d-block w-100" src="img/CentroAcuatico.jpg" alt="Third slide">
      </div>
      <div class="carousel-item">
        <img class="d-block w-100" src="img/F1D1" alt="Third slide">
      </div>
      <div class="carousel-item">
        <img class="d-block w-100" src="img/Biblioteca" alt="Third slide">
      </div>
      <div class="carousel-item">
        <img class="d-block w-100" src="img/Polideportivo" alt="Third slide">
      </div>
    </div>
  </div>
