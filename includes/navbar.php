<nav id="navbar" style="background-color:#091c5a !important;" class="navbar navbar-expand-lg navbar-dark bg-primary py-4">
    <div class="container-fluid">
        <img src="./assets/img/logos/unah_logo_navbar.jpeg" alt="Logo UNAH" style="width: 50px; height: 50px;" class="mx-lg-5 mx-md-3 mx-sm-2">
        <a style="color:#ffcc00;" class="navbar-brand" href="index.php">Registro UNAH</a>
